...
if [ -z "${template}" ]; then
    echo "Available templates: None, Sorry we are not supporting any python template for now, Please use the default to edit."
    exit
...
template_url="https://github.com/WESCO-International/template-python-${template}"
